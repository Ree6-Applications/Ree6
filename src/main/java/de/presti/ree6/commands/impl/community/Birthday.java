    ...
    public void onPerform(CommandEvent commandEvent) {
        ...
        if (commandEvent.getArguments().length == 1) {
            if (commandEvent.getArguments()[0].equalsIgnoreCase("remove")) {
                ...
                Main.getInstance().getCommandManager().sendMessage(Language.getResource(commandEvent.getGuild(), "command.message.birthday.removed.self"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
            ...
            if (commandEvent.getArguments()[0].equalsIgnoreCase("remove")) {
                if (commandEvent.getMember().hasPermission(Permission.ADMINISTRATOR)) {
                    if (commandEvent.getMessage() != null &&
                        ...
                        Main.getInstance().getCommandManager().sendMessage(Language.getResource(commandEvent.getGuild(), "command.message.default.noMention.user"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
                    } else {
                        ...
                        Main.getInstance().getCommandManager().sendMessage(Language.getResource(commandEvent.getGuild(), "command.message.birthday.removed.other", commandEvent.getMessage().getMentions().getMembers().get(0).getAsMention()), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
                    }
                } else {
                    Main.getInstance().getCommandManager().sendMessage(Language.getResource(commandEvent.getGuild(), "command.message.birthday.removed.noPerms"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
                }
                ...
                if (GenericValidator.isDate(commandEvent.getArguments()[1], "dd.MM.yyyy", true)) {
                    ...
                    Main.getInstance().getCommandManager().sendMessage(Language.getResource(commandEvent.getGuild(), "command.message.added.self"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
                } else {
                    Main.getInstance().getCommandManager().sendMessage(Language.getResource(commandEvent.getGuild(), "command.message.other.dateError"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
                }
            } else {
                Main.getInstance().getCommandManager().sendMessage(Language.getResource(commandEvent.getGuild(), "command.message.default.usage", Main.getInstance().getSqlConnector().getSqlWorker().getSetting(commandEvent.getGuild().getId(), "chatprefix").getStringValue(), "birthday add/remove [Birthday(day.month.year)] [@User]"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
            }
                ...
                if (GenericValidator.isDate(commandEvent.getArguments()[1], "dd.MM.yyyy", true)) {
                    if (commandEvent.getMember().hasPermission(Permission.ADMINISTRATOR)) {
                        if (commandEvent.getMessage() != null &&
                            ...
                            Main.getInstance().getCommandManager().sendMessage(Language.getResource(commandEvent.getGuild(), "command.message.birthday.added.other", commandEvent.getMessage().getMentions().getMembers().get(0).getAsMention()), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
                        }
                    } else {
                        Main.getInstance().getCommandManager().sendMessage(Language.getResource(commandEvent.getGuild(), "command.message.birthday.added.noPerms"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
                    }
                } else {
                    Main.getInstance().getCommandManager().sendMessage(Language.getResource(commandEvent.getGuild(), "command.message.other.dateError"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
                }
