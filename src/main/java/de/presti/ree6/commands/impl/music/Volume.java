...
public class Volume extends Command {
    ...
    public Volume() {
        super("volume", "Set the Volume!", Category.MUSIC, new CommandData("volume", "Set the Volume!").addOptions(new OptionData(OptionType.INTEGER, "volume", "The Volume that the Ree6 Music Player should be!").setRequired(true)));
    }
