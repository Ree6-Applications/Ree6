            ...
            case "punishments" -> {
                ...
                switch (subCommand) {
                    ...
                    case "list" -> {
                        ...
                        for (Punishments punishments : SQLSession.getSqlConnector().getSqlWorker().getEntityList(new Punishments(), "SELECT * FROM Punishments WHERE guildId = :gid", Map.of("gid", commandEvent.getGuild().getIdLong()))) {
