...
public class Kiss implements ICommand {
    ...
    public CommandData getCommandData() {
        return new CommandDataImpl("kiss", "command.description.kiss")
    ...
    public void sendKiss(Member member, CommandEvent commandEvent) {
        ...
        if (!commandEvent.isDetached()) {
            ...
            messageCreateBuilder.setContent(commandEvent.getResource("message.kiss", member.getAsMention(), commandEvent.getMember().getAsMention()) + "\n" + (im != null ? im.getUrl() : "https://images.ree6.de/notfound.png"));
