    ...
    public void onPerform(CommandEvent commandEvent) {
        ...
        if(commandEvent.getArguments().length == 1) {
            if(commandEvent.getArguments()[0].equalsIgnoreCase("list")) {
                ...
                Main.getInstance().getCommandManager().sendMessage(commandEvent.getResource("command.message.default.usage","twitternotifier list/add/remove"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
            }
            ...
            if (commandEvent.getMessage().getMentions().getChannels(TextChannel.class).isEmpty() ||
                ...
                Main.getInstance().getCommandManager().sendMessage(commandEvent.getResource("command.message.default.usage","twitternotifier add/remove TwitterName #Channel"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
                return;
            }
            ...
            if (commandEvent.getArguments()[0].equalsIgnoreCase("add")) {
                ...
                Main.getInstance().getCommandManager().sendMessage(commandEvent.getResource("command.message.twitterNotifier.added",name), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
                ...
                Main.getInstance().getCommandManager().sendMessage(commandEvent.getResource("command.message.default.usage","twitternotifier remove TwitterName"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
            } else {
                Main.getInstance().getCommandManager().sendMessage(commandEvent.getResource("command.message.default.usage","twitternotifier add TwitterName #Channel"), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
            }
            ...
            if(commandEvent.getArguments()[0].equalsIgnoreCase("remove")) {
                ...
                Main.getInstance().getCommandManager().sendMessage(commandEvent.getResource("command.message.twitterNotifier.removed",name), 5, commandEvent.getChannel(), commandEvent.getInteractionHook());
