...
public abstract class CommandClass {
     ...
     */
    protected CommandClass(String command, String description, Category category) {
        name = command;
     ...
     */
    protected CommandClass(String command, String description, Category category, String[] alias) {
        name = command;
        this.description = description;
        this.category = category;
        this.alias = alias;
     ...
     */
    protected CommandClass(String command, String description, Category category, CommandData commandData) {
        name = command;
        this.description = description;
        this.category = category;
     ...
     * @param commandData the custom CommandData
     */
    protected CommandClass(String command, String description, Category category, String[] alias, CommandData commandData) {
        name = command;
        this.description = description;
        this.category = category;
        this.alias = alias;
