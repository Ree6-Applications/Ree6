...
public class SQLWorker {
    ...
    public HashMap<String, Long> getStatsFromGuild(String gid) {
        ...
        try {
            ...
            try {
                st = Main.sqlConnector.con.prepareStatement("SELECT * FROM GuildStats WHERE GID='" + gid + "' ORDER BY cast(uses as integer) DESC LIMIT 50");
                rs = st.executeQuery("SELECT * FROM GuildStats WHERE GID='" + gid + "' ORDER BY cast(uses as integer) DESC LIMIT 50");
            } catch (Exception ignore) {
            }
    ...
    public HashMap<String, Long> getStatsForCommands() {
        ...
        try {
            ...
            try {
                st = Main.sqlConnector.con.prepareStatement("SELECT * FROM CommandStats ORDER BY cast(uses as integer) DESC LIMIT 50");
                rs = st.executeQuery("SELECT * FROM CommandStats ORDER BY cast(uses as integer) DESC LIMIT 50");
            } catch (Exception ignore) {
            }
